...
!!! info "Доступные TableNumbers (LTN, код местности)"
    ...
    Работает только один LTN, тот, что находится сверху в списке. Поэтому в адаптациях необходимо выставить нужный с префиксом 5. Например, для - Москвы 523.  
    Либо можно задать единый префикс настроек в файлах конфигурации для всех городов, а так же за пределами РФ: 15
