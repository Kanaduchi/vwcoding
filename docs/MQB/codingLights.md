...
# Кодирование светового оборудования <br> (в разработке)
...
!!! warning ""
    ...
    При установки слишком маленькой яркости (< 25) канал может выдавать ошибку.   
...
Проводится при наличии висящей AFS ошибки
