...
Настройка блока 3C (ассистент смены полосы движения)
``` yaml
Блок 3C → Кодирование:
...
!!! note "Готовое кодирование"
    ...
    Например, готовую кодировку можно [Открыть в калькуляторе](../../utils/longCoding/?code=000307060007040100222346C154890098000E20004000&label=A5_3Q0)
...
``` yaml title="в ODIS в блок A5 нужно войти в режиме разработчика, логин 89687"
Блок A5 (камера ассистентов) → Адаптация:
