...
- [Кодирование 2Q* камеры](2Q0_assistants.md) — FEC-таблица и кодировки ассистентов  
- [Активация ACC и pACC (SWaP радара)](pACC.md) — общая теория SWaP и `afcg.exe`  
- [Прошивки и параметрия A5](camAssistFirmwares.md)  
- [Инструкция ODIS E](../utils/odis-e.md) — меню 005, 007, 042  
