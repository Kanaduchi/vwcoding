# SWAP коды и параметрии

!!! warning 
    ВСЕ, ЧТО ВЫ БУДЕТЕ ДЕЛАТЬ, ЭТО ТОЛЬКО ВАША ОТВЕТСТВЕННОСТЬ...(ЕСЛИ НЕ УВЕРЕНЫ НЕ НАЧИНАЙТЕ)
...
работает без танцов с бубном, так сказать из посылки или другое устройство с чипом ASIX 88772
...
3. Активированное инженерное меню  
...
4. Патч FEC кодов [(MST2_backup.sh)](../firmwares/MST2_fec.sh)  
