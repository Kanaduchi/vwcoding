...
Там будет код его нужно ввнеси http://mib-helper.com/im-so-xory/ и получить ответный код 
и его вбить и подтвердить...
```

### Теперь самое главное и трудное....Если не готовы не проджолжайте...
