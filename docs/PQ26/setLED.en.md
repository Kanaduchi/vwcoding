...
# LED lamps in the rear dimensions
``` yaml title="Login code: 31347"
Block 09 → Adaptation:
...
# LED lamps in the rear turn signals
``` yaml title="Login code: 31347"
Block 09 → Adaptation:
...
# LED lamps in the front direction indicators
``` yaml title="Login code: 31347"
Block 09 → Adaptation:
...
# LED lamps in the front side lights
``` yaml title="Login code: 31347"
Block 09 → Adaptation:
