...
!!! warning "" При такой кодировке невозможно использовать дальний вместе с противотуманками.
```
Блок 09 → Адаптация 
...
```
Блок 09 → Адаптация 
> Aussenlicht_Blinker-Komfortblinken_Blinkzyklen – выбрать значение от 1 до 5 (с завода по умолчанию – 3)
→ Применить
```
> логин-пароль 31347
