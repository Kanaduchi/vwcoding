...
```
Блок 09 → Кодирование
> Байт 17 – бит 0 – включить.
> Байт 17 – бит 4 – включить.
→ Применить (с перезагрузкой блока)
```
```
Блок 09 → Адаптация
...
```
Блок 01 → Кодирование
> Байт 6 – бит 2 – включить
→ Применить 
```
```
Блок 09 → Кодирование
> Байт 18 – бит 7 – включить
→ Применить 
```
...
```
Блок 19 → Кодирование
> Байт 1 — бит 0 — включить
→ Применить (с перезагрузкой блока)
```
```
Блок 09 → Кодирование
> Байт 20 — бит 1 — включить
→ Применить 
```
> логин-пароль 31347
...
> 0 – Ассистент управления дальним светом - включить
→ Применить (с перезагрузкой блока)
```
```
Блок 09 → Кодирование 
