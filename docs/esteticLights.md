...
+ [ODIS_E файл предустановок для включения привязки цветов к профилям движения для машин с установленным RGB включает в себя шкалу 12 подобранных RGB цветов для 09 блока (адаптации)](../odis-files/09 - RGB Lin цвета с профилями.zip)
