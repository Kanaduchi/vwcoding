...
``` yaml
Блок 9 → Кодование → 1 блок Wischer → Длинное кодирование:
...
``` yaml
Блок 9 → Кодование → 2 блок RLS → Длинное кодирование:
...
``` yaml
Блок 8 → Кодование → Длинное кодирование:
> Байт 2 – Бит 0: Активировать
```
...
``` yaml
Блок 16 → Кодование → Длинное кодирование:
