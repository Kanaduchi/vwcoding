...
### 12.06.2026
1. Добавлена английская версия сайта: перевод документации, переключатель языка в шапке
2. Добавлен раздел SFD
3. Исправлены опечатки с кириллическими символами в латинских обозначениях кодировок (RLHS, hex-значения и др.)
4. Обновлены README и CONTRIBUTING для двуязычной структуры проекта
5. Расширен раздел SFD: таблицы инструментов, блоков и типичных ошибок
6. MEB: страницы климат, зарядка/HV, BCM
7. MQB-Evo: доп. ассистенты (EA, TJA, блок 44, V2X/TA 2024+)
8. MQB: прошивки камеры A5 для Evo (5WA 980 653); исправлена ссылка на PDF Octavia A7 (имя файла с дефисами)
9. Переименован odis-file 6С → 6C (маневровый свет)
10. MQB: полная инструкция SWaP для камеры 2Q0980653 (`2Q0_swap.md`, способы A/B через вкладки)
11. utils: инструкция ODIS E перенесена из PDF в markdown (`odis-e.md`)

### 03.01.2026
1. Исправлена ошибка при загрузке js скриптов

### 10.12.2025
1. Обновлен UI
2. Добавлены новые кодировки для ряда платформ
3. Обновлены кодировки, исправлено множество ошибок
4. Исправлены скрипты для работы с утилитами

### 21.02.2025
1. Обновление файла кодировки камеры A5 2q
...
### 22.04.2022
1. Новые кодировки: сброс давления в салоне, стоп-сигналы при открытии задних дверей
...
### 13.01.2021
1. В online калькулятор длинного кодирования добавлена расшифровка блока A5
...
2. Добавлен pdf файл с MQB кодировками для Škoda Octavia A7
